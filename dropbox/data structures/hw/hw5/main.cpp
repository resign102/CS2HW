...
void StudentTests() {
  ...
  //Odd number of engines w/ two in the front, odd number of cars
  t = NULL;
  PushBack(t, TrainCar::MakeEngine()); 
  PushBack(t, TrainCar::MakeEngine());
  PushBack(t, TrainCar::MakePassengerCar());
  ...
  //Odd number of engines w/ two in the front, even number of cars
  t = NULL;
  PushBack(t, TrainCar::MakeEngine()); 
  PushBack(t, TrainCar::MakeEngine());
  PushBack(t, TrainCar::MakePassengerCar());
  ...
  //even number of engines w/ two in the front, even number of cars,
  //two train begins and ends with engine
  t = NULL;
  PushBack(t, TrainCar::MakeEngine()); 
  PushBack(t, TrainCar::MakeEngine());
  PushBack(t, TrainCar::MakePassengerCar());
  ...
  //Lots of engines. Maybe the train transports engines?
  t = NULL;
  PushBack(t, TrainCar::MakeEngine()); 
  PushBack(t, TrainCar::MakeEngine());
  PushBack(t, TrainCar::MakeEngine());
  ...
  //Even worse--three engines in the beginning
  //(accounting for even more than one should fix this in theory)
  t = NULL;
  PushBack(t, TrainCar::MakeEngine()); 
  PushBack(t, TrainCar::MakeEngine());
  PushBack(t, TrainCar::MakeEngine());
  ...
  SeparateTestHelper(t, "#8");
	...
	//lots of engines w/ none at beginning
  t = NULL;
  PushBack(t, TrainCar::MakePassengerCar());
  PushBack(t, TrainCar::MakePassengerCar());
  PushBack(t, TrainCar::MakeDiningCar());
